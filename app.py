...
st.markdown("Advanced B-Book risk management and toxin detection via file upload.")
...
if uploaded_file is None:
    ...
    try:
        ...
        # Looks for trades where the volume is 1.5x larger than the previous trade, and the previous trade was a loss.
        ...
        # Highly profitable trades closed in under 1 minute
        ...
        st.download_button("📥 Download Full Excel Risk Report", data=buffer, file_name="Equitas_Intel.xlsx", mime="application/vnd.ms-excel")
